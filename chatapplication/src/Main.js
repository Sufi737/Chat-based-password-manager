  ...
  async logIn() {
    ...
    try {
      ...
      if (data["status_code"] === "success") {
        ...
        this.state.messages.push(["server", "1. Add a new password 2. Get credentials. Send number 1 or 2 accordingly"])
